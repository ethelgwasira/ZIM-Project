...
burnin_id = "bd6912f4-791a-ed11-a9fb-b88303911bc1"  # UPDATE with burn-in experiment id
pull_year = 50  # year of burn-in to pick-up from
pickup_years = 10  # years of pick-up to run
numseeds = 1
...
def case_management(cb, cm_cov_U5=0.5, cm_cov_adults=0.4):
...
# def itn_intervention(cb, coverage_level = 0.52, day=960):
#     add_ITN(cb,
...
#             ],
#             repetitions=0,  # ITN will be distributed 0 times
...
def irs_intervention(cb, KE):
    ...
    irs_covs = [0.33, 0.44, 0.2, 0.6, 0.86, 0.57, 0.3, 0.8, 0.86, 0.95 ]  # 0, 0, 0, 0, 0.36, 0.43, 0.8, 0.85, 0.92,0.997, 0.995, 0.94, 0.832, 0.832
    KEs=[0.15,0.15,0.15, 0.065, 0.037]              # 0.30, 0.29, 0.28, 0.27, 0.26,0.25,0.24,0.18,0.15,
...
expt_name = f'{user}_Zimbabwe_Mutasa_PickupA{pickup_years}'
