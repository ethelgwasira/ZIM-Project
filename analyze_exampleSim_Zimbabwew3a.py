...
expt_name = f'{user}_ZIM-project_Zimbabwew3a'
expt_id = '2022_07_03_23_10_11_874071'  ## change expt_id
...
#    event_list = ['Received_Treatment', 'Received_ITN', 'Received_SMC', 'Received_Vaccine']
    event_list = ['Received_Treatment', 'Received_IRS', 'Received_ITN']
