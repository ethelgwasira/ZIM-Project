...
"""Demographics"""
cb.update_params({
    'Demographics_Filenames': [os.path.join('Mutasa_demographics.json')],
    "Air_Temperature_Filename": os.path.join('Mutasa_air_temperature_daily.bin'),
    "Land_Temperature_Filename": os.path.join('Mutasa_air_temperature_daily.bin'),
    "Rainfall_Filename": os.path.join('Mutasa_rainfall_daily.bin'),
    "Relative_Humidity_Filename": os.path.join('Mutasa_relative_humidity_daily.bin'),
...
run_sim_args = {
    'exp_name': f'{user}_Zimbabwe_Mutasa_Burnin{serialize_years}',
    'config_builder': cb,
    'exp_builder': builder
}
