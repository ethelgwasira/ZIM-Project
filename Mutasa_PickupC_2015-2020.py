...
burnin_id = "8484aae4-cc1d-ed11-a9fb-b88303911bc1"  # UPDATE with burn-in experiment id
pull_year = 4  # year of burn-in to pick-up from
pickup_years = 6  # years of pick-up to run
numseeds = 1
...
def irs_intervention(cb, KE):
    ...
    irs_covs = [ 0.997, 0.995, 0.94, 0.832, 0.832]  # 0, 0, 0, 0, 0.36, 0.43, 0.8, 0.85, 0.92,
...
for i in range(pickup_years):
    add_summary_report(cb, start=1+365*i, interval=30,
                       ...
                       age_bins=[0.25, 5, 100],
                       # age_bins=[0.25, 5, 120],
                       description=f'Monthly_U5_{2015+i}')

# run_sim_args is what the `dtk run` command will look for
user = os.getlogin()  # user initials
expt_name = f'{user}_Zimbabwe_Mutasa_Pickup{pickup_years}'
